...
<html>
    ...
    <body onload="showNoti()">
        ...
        <div id="navigator" style="width: 110vw">
            <a style="margin-left: 0px; margin-top: 0px" href="MainController?action=GetPage"><img src="https://khanghv.blob.core.windows.net/khanghv/BackGround.jpg" width="100px" height="100px"/></a>
